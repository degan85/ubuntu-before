...
public class EmployeeSearchServletTest {
	...
	public void testSearchByEmpid() throws Exception {
		...
		Employee expectedEmployee = new Employee("박성철","5874","funpin","회장");
...
//		assertLenEquals(expectedEmployee, employee);
//		
//		assertEquals("/SearchRequest.jsp", response.getForwardedUrl());
	}
}
